...
You can look up users by their Roblox ID or username, and the block will return information about the user. However, this node is currently broken and cannot search for a roblox user due to the roblox API changes.
